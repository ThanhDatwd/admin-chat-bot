...
import CreateAdminAccountForm from '../create-admin-account-form';
import CreateCustomerInfoForm from '../create-customer-info-form';
import CreateCustomerConfigForm from '../create-customer-config-form';
import CreateCustomerContractForm from '../create-customer-contract-form';
  ...
  const steps = [
    {
      ...
      content: <CreateCustomerInfoForm/>,
    },
    {
      title: t('Thông tin tổ chức'),
      content: <CreateCustomerContractForm/>,
    },
    {
      title: t('Thông tin cấu hình'),
      content: <CreateCustomerConfigForm/>
    }
  ];
  const totalSteps = () => {
    return steps.length;
